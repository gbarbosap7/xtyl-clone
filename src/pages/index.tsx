    ...
    <>
      ...
      <main className="min-h-screen bg-xtyl-black">
        ...
        <section className="h-screen flex flex-col items-center justify-center px-4 relative">
          <div className="text-center max-w-5xl">
            <motion.div
              ...
              className="inline-block bg-xtyl-primary/10 rounded-full px-6 py-2 mb-8"
            >
              <p className="text-white text-sm">Procurando uma Assessoria de Marketing?</p>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-5xl md:text-7xl font-clash-display font-bold text-white mb-4"
            >
              O X da Questão é{' '}
              <span className="bg-gradient-to-r from-xtyl-primary to-xtyl-accent text-transparent bg-clip-text">
                Vender Mais
              </span>
            </motion.h1>
            ...
            >
              <Link
                ...
                className="bg-xtyl-primary hover:bg-xtyl-primary/90 text-xtyl-black font-medium px-8 py-3 rounded-full flex items-center gap-2 transition-colors"
              >
              ...
              <Link
                href="/cases"
                className="border border-xtyl-primary/20 hover:bg-xtyl-primary/10 text-white font-medium px-8 py-3 rounded-full transition-colors"
              >
        ...
        <div className="fixed bottom-8 right-8 z-50">
          <Link
            href="https://wa.me/seu-numero"
            className="bg-xtyl-primary hover:bg-xtyl-primary/90 text-xtyl-black font-medium p-4 rounded-full flex items-center gap-2 transition-colors shadow-lg"
          >
