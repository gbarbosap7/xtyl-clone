        ...
        <section className="h-screen flex flex-col items-center justify-center px-4 relative">
          <div className="text-center max-w-5xl">
            <motion.div
              ...
              className="inline-block bg-[#1A2C2C] bg-opacity-50 rounded-full px-6 py-2 mb-8"
            >
            ...
            >
              <Link
                ...
                className="bg-[#4ADE80] hover:bg-[#3ECE70] text-black font-medium px-8 py-3 rounded-full flex items-center gap-2 transition-colors"
              >
              ...
              <Link
                href="/cases"
                className="border border-white/20 hover:bg-white/10 text-white font-medium px-8 py-3 rounded-full transition-colors"
              >
