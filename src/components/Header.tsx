    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-4 py-6">
      <div className="max-w-7xl mx-auto">
        <motion.nav
          ...
          className="flex items-center justify-between bg-[#1A2C2C]/30 backdrop-blur-lg rounded-full px-8 py-4 border border-white/10"
        >
          ...
          <Link
            ...
            className="bg-[#7AFF64] hover:bg-[#6AEE54] text-black font-medium px-6 py-2 rounded-full flex items-center gap-2 transition-colors"
          >
