    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-4 py-6">
      <div className="max-w-7xl mx-auto">
        <motion.nav
          ...
          className="flex items-center justify-between bg-[#1A2C2C] bg-opacity-50 backdrop-blur-lg rounded-full px-6 py-3"
        >
          <Link href="/" className="text-white font-clash-display text-2xl font-bold">
            XTYL
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/cases" className="text-white hover:text-gray-300 transition-colors">
              Cases
            </Link>
          ...
          <div className="flex items-center space-x-4">
            <Link
              ...
              className="bg-[#4ADE80] hover:bg-[#3ECE70] text-black font-medium px-6 py-2 rounded-full flex items-center gap-2 transition-colors"
            >
            ...
            <div className="flex items-center space-x-2">
              <Link href="?lang=pt" className="text-white hover:text-gray-300 transition-colors">
                PT
              </Link>
              <Link href="?lang=en" className="text-white hover:text-gray-300 transition-colors">
                EN
              </Link>
              <Link href="?lang=fr" className="text-white hover:text-gray-300 transition-colors">
                FR
              </Link>
            </div>
          </div>
